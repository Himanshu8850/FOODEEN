  ...
  return (
    <div className="bg-gray p-5 md:p-10 flex gap-10">
      ...
      <div className="font-alveria flex-1 flex flex-col justify-start text-center items-center gap-6 border-[3px] border-r-teal-400 border-b-teal-400 border-t-white border-l-white px-5 py-5">
        <h1 className="font-fontTwo text-3xl font-bold text-white bg-teal-200/80 px-3 pt-2 cursor-pointer rounded-lg">
          ABOUT US
        </h1>
        <div
          className={`text-lg flex flex-col gap-5 leading-10 ${isDarkMode ? "bg-gray-900/70 text-white" : "bg-white/70 text-gray-900"} rounded-xl p-6`}
        >
          <p className="text-lg">
            FOODEEN is a web application aimed at reducing food waste by
